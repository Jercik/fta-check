 ...
 */
const DEFAULT_CONFIG: FtaConfig = {
 ...
 */
function readConfigFile(directory: string): FtaConfig | undefined {
 ...
 */
function mergeConfig(defaultConfig: FtaConfig, repoConfig?: FtaConfig): FtaConfig {
